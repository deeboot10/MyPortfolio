...
const reviews = [
  { name: "Davorin Jenko", text: "He's a team player always ready to jump in for help.", role: "Ex Colleague" },
  { name: "Milan Karadžić", text: "His brilliance and dedication to programming astonish me ever single day!", role: "University Professor" },
  { name: "Milica Dabović", text: "Team work makes the dream work", role: "Ex Basketball Player" },
];
  ...
  return (
    <div id="testimonials">
      ...
      <div className="sliderCont">
        ...
        <div className="my-slider">{reviewsDom}</div>
